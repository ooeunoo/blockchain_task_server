...
import { SushiSwapMATICService } from '../../defi/sushi-swap/sushi-swap.matic.service';
...
@Injectable()
export class SushiSwapJobMATICFarmService extends FarmTemplate {
  constructor(
    ...
    public readonly context: SushiSwapMATICService,
  ) {
    super(
      ID.SUSHI_SWAP.MATIC.FARM,
